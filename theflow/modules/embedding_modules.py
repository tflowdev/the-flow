...
from theflow.constants import TYPE
from theflow.modules.initializer_modules import get_initializer
from theflow.utils.data_utils import load_pretrained_embeddings
...
class EmbedWeighted(The FlowModule):
...
# class EmbedSparse(The FlowModule):
#     def __init__(
#             self,
#             vocab: List[str],
...
class EmbedSequence(The FlowModule):
    def __init__(
        self,
        vocab: List[str],
        embedding_size: int,
...
class TokenAndPositionEmbedding(The FlowModule):
    def __init__(
        self,
        max_sequence_length,
        vocab,
