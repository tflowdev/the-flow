...
if TYPE_CHECKING:
    from theflow.schema.optimizers import BaseOptimizerConfig, GradientClippingConfig


def create_clipper(gradient_clipping_config: Optional["GradientClippingConfig"]):
    from theflow.schema.optimizers import GradientClippingConfig
...
def create_optimizer(
    ...
    :param optimizer_config: Instance of `theflow.modules.optimization_modules.BaseOptimizerConfig`.
