...
class FeedForwardAttentionReducer(The FlowModule):
...
class MultiHeadSelfAttention(The FlowModule):
...
class TransformerBlock(The FlowModule):
    def __init__(
        self,
        input_size: int,
...
class TransformerStack(The FlowModule):
    def __init__(
        self,
        input_size: int,
        max_sequence_length: int,
