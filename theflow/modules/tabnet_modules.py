...
from theflow.modules.normalization_modules import GhostBatchNormalization
from theflow.utils.entmax import Entmax15, EntmaxBisect, Sparsemax
from theflow.utils.torch_utils import The FlowModule


class TabNet(The FlowModule):
    def __init__(
        self,
        input_size: int,
        size: int,
...
class FeatureBlock(The FlowModule):
    def __init__(
        self,
        input_size: int,
        size: int,
        ...
        shared_fc_layer: The FlowModule = None,
    ):
        super().__init__()
        self.input_size = input_size
...
class AttentiveTransformer(The FlowModule):
    def __init__(
        self,
        input_size: int,
        size: int,
...
class FeatureTransformer(The FlowModule):
    def __init__(
        self,
        input_size: int,
        size: int,
