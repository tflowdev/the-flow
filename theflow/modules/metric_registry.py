...
from theflow.constants import LOGITS, MAXIMIZE, MINIMIZE, PREDICTIONS, PROBABILITIES, RESPONSE
...
def get_metric_classes(feature_type: str) -> Dict[str, "The FlowMetric"]:
    return metric_feature_type_registry[feature_type]


def get_metric_cls(feature_type: str, name: str) -> "The FlowMetric":
...
@DeveloperAPI
def get_metric(metric_name: str) -> "The FlowMetric":  # noqa
    return get_metric_registry()[metric_name]


@DeveloperAPI
def get_metrics_for_type(feature_type: str) -> Dict[str, "The FlowMetric"]:  # noqa
