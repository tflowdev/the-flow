...
from theflow.backend import ALL_BACKENDS, Backend
from theflow.callbacks import Callback
from theflow.constants import FULL, TEST, TRAINING, VALIDATION
from theflow.contrib import add_contrib_callback_args
from theflow.globals import LUDWIG_VERSION
from theflow.utils.print_utils import get_logging_level_registry, print_boxed, print_theflow
...
def cli_collect_activations(sys_argv):
    ...
    parser = argparse.ArgumentParser(
        ...
        prog="theflow collect_activations",
    ...
    global logger
    logger = logging.getLogger("theflow.collect")

    print_theflow("Collect Activations", LUDWIG_VERSION)
...
def cli_collect_weights(sys_argv):
    ...
    print_theflow("Collect Weights", LUDWIG_VERSION)
...
def cli_collect_summary(sys_argv):
    ...
    print_theflow("Collect Summary", LUDWIG_VERSION)
