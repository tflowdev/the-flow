...
from theflow.constants import BASE_MODEL, MODEL_ECD, MODEL_LLM, MODEL_TYPE
...
from theflow.schema.utils import unload_jsonschema_from_marshmallow_class
...
def get_schema(model_type: str = MODEL_ECD):
    ...
    import theflow.combiners.combiners  # noqa: F401
    from theflow.schema.model_types.base import model_type_schema_registry
    ...
    return {
        ...
        "properties": props,
        "title": "model_options",
        "description": "Settings for The Flow configuration",
        "required": required,
...
def check_schema(updated_config):
    ...
    The incoming config may not be comprehensive, but is assumed to be up to date with the latest theflow schema.
    """
