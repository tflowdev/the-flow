...
from theflow.globals import MODEL_FILE_NAME, MODEL_HYPERPARAMETERS_FILE_NAME, MODEL_WEIGHTS_FILE_NAME
from theflow.utils.print_utils import get_logging_level_registry
from theflow.utils.upload_utils import HuggingFaceHub, Predibase
...
def cli(sys_argv):
    ...
    parser.add_argument(
        ...
        default="Upload trained [The Flow](https://theflow.ai/latest/) model weights",
    )
    ...
    global logger
    logger = logging.getLogger("theflow.upload")
