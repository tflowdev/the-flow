...
from theflow.schema.features.sequence_feature import SequenceInputFeatureConfig, SequenceOutputFeatureConfig
...
from theflow.utils.tokenizers import get_tokenizer_from_registry
...
class SequenceOutputFeature(SequenceFeatureMixin, OutputFeature):
    ...
    def calculate_overall_stats(predictions, targets, train_set_metadata):
        ...
        # https://github.com/theflow-ai/theflow/blob/tf-legacy/theflow/features/sequence_feature.py#L411
        return {}
