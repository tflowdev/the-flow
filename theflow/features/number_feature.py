...
from theflow.constants import COLUMN, HIDDEN, LOGITS, NAME, NUMBER, PREDICTIONS, PROC_COLUMN
from theflow.features.base_feature import BaseFeatureMixin, InputFeature, OutputFeature, PredictModule
from theflow.schema.features.number_feature import NumberInputFeatureConfig, NumberOutputFeatureConfig
    ...
    def __init__(self, mean: float = None, std: float = None, **kwargs: dict):
        ...
        if self.sigma == 0:
            raise RuntimeError(
                ...
                "the dataset. Consider removing this feature from your The Flow config since it is not useful for "
