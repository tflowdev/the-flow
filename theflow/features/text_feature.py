...
from theflow.features.base_feature import BaseFeatureMixin, OutputFeature
from theflow.features.feature_utils import compute_sequence_probability, compute_token_probabilities
from theflow.features.sequence_feature import (
    _SequencePostprocessing,
    _SequencePreprocessing,
    SequenceInputFeature,
    SequenceOutputFeature,
)
from theflow.modules.metric_registry import get_metric_tensor_input
from theflow.schema.features.text_feature import TextInputFeatureConfig, TextOutputFeatureConfig
from theflow.types import FeatureMetadataDict, ModelConfigDict, PreprocessingConfigDict, TrainingSetMetadataDict
from theflow.utils.math_utils import softmax
from theflow.utils.strings_utils import (
...
class TextFeatureMixin(BaseFeatureMixin):
    ...
    def feature_data(column, metadata, preprocessing_parameters: PreprocessingConfigDict, backend) -> np.ndarray:
        # TODO(1891): Remove backward compatibility hack once all models have been retrained with The Flow after
        # https://github.com/theflow-ai/theflow/pull/1859.
        prefix = ""
