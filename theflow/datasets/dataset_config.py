...
@dataclass
class DatasetConfig:
    """The configuration of a The Flow dataset."""
    ...
    # The loader module and class to use, relative to theflow.datasets.loaders. Only change this if the dataset requires
