...
def cli(sys_argv):
    parser = argparse.ArgumentParser(
        description="This script preprocess a dataset", prog="theflow preprocess", usage="%(prog)s [options]"
    )
    ...
    global logger
    logger = logging.getLogger("theflow.preprocess")

    args.backend = initialize_backend(args.backend)
    if args.backend.is_coordinator():
        print_theflow("Preprocess", LUDWIG_VERSION)
