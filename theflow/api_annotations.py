...
def PublicAPI(*args, **kwargs):
    """Annotation for documenting public APIs. Public APIs are classes and methods exposed to end users of The Flow.

    If stability="stable", the APIs will remain backwards compatible across minor The Flow releases
    (e.g., The Flow 0.6 -> The Flow 0.7).
    ...
    def wrap(obj):
        if stability == "experimental":
            ...
            message = "PublicAPI: This API is stable across The Flow releases."
...
def DeveloperAPI(*args, **kwargs):
    ...
    advanced The Flow users and library developers. Their interfaces may change across minor The Flow releases (for
    e.g., The Flow 0.6.1 and The Flow 0.6.2).
    ...
    def wrap(obj):
        _append_doc(obj, message="DeveloperAPI: This API may change across minor The Flow releases.")
        _mark_annotated(obj)
        return obj
...
def Deprecated(*args, **kwargs):
    """Annotation for documenting a deprecated API. Deprecated APIs may be removed in future releases of The Flow
    (e.g., The Flow 0.7 to The Flow 0.8).
    ...
    message = "**DEPRECATED:** This API is deprecated and may be removed in a future The Flow release."
