...
from theflow.constants import BINARY, ENCODER_OUTPUT, NUMBER
from theflow.encoders.registry import get_sequence_encoder_registry
from theflow.features.base_feature import InputFeature
from theflow.modules.attention_modules import TransformerStack
from theflow.modules.embedding_modules import Embed
from theflow.modules.fully_connected_modules import FCStack
from theflow.modules.reduction_modules import SequenceReducer
from theflow.modules.tabnet_modules import TabNet
from theflow.schema.combiners.base import BaseCombinerConfig
from theflow.schema.combiners.comparator import ComparatorCombinerConfig
from theflow.schema.combiners.concat import ConcatCombinerConfig
from theflow.schema.combiners.project_aggregate import ProjectAggregateCombinerConfig
from theflow.schema.combiners.sequence import SequenceCombinerConfig
from theflow.schema.combiners.sequence_concat import SequenceConcatCombinerConfig
from theflow.schema.combiners.tab_transformer import TabTransformerCombinerConfig
from theflow.schema.combiners.tabnet import TabNetCombinerConfig
from theflow.schema.combiners.transformer import TransformerCombinerConfig
from theflow.utils.misc_utils import get_from_registry
from theflow.utils.registry import Registry
from theflow.utils.torch_utils import The FlowModule, sequence_length_3D
from theflow.utils.torch_utils import sequence_mask as torch_sequence_mask
...
@DeveloperAPI
class Combiner(The FlowModule, ABC):
    ...
    def forward(self, inputs: Dict) -> Dict:  # encoder outputs
        if self.main_sequence_feature is None or self.main_sequence_feature not in inputs:
            for if_name, if_outputs in inputs.items():
                # todo: when https://github.com/theflow-ai/theflow/issues/810 is closed
