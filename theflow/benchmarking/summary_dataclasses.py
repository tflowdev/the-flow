...
import theflow.modules.metric_modules  # noqa: F401
from theflow.benchmarking.utils import format_memory, format_time
from theflow.globals import MODEL_FILE_NAME, MODEL_HYPERPARAMETERS_FILE_NAME
from theflow.modules.metric_registry import get_metric_classes, metric_feature_type_registry  # noqa: F401
...
class MetricsSummary:
    ...
    # Full The Flow config.
    config: ModelConfigDict

    # The FlowModel output feature type.
    output_feature_type: str

    # The FlowModel output feature name.
...
def build_metrics_diff(
    ...
    :param dataset_name: the name of the The Flow dataset.
...
def average_runs(path_to_runs_dir: str) -> Dict[str, Union[int, float]]:
    ...
    :param path_to_runs_dir: path to where metrics specific to a tag are stored.
        e.g. resource_usage_out_dir/torch_ops_resource_usage/The FlowModel.evaluate/
