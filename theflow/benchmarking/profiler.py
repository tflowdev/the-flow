...
from theflow.benchmarking.profiler_dataclasses import profiler_dataclass_to_flat_dict, TorchProfilerMetrics
from theflow.benchmarking.reporting import get_metrics_from_system_usage_profiler, get_metrics_from_torch_profiler
...
class The FlowProfiler(contextlib.ContextDecorator):
    ...
    def _populate_static_information(self) -> None:
        ...
        self.info["theflow_version"] = LUDWIG_VERSION
    ...
    def __enter__(self):
        ...
        if self.launched:
            raise RuntimeError("The FlowProfiler already launched. You can't use the same instance.")
