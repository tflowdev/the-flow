...
def ProfilerDataclassField(description: str, default: Dict = {}):
    """Returns custom dataclass field for `theflow.modules.profiler.ProfilerConfig`. Allows `None` by default.
    ...
    class ProfilingMarshmallowField(fields.Field):
        ...
        Deserializes a dict to a valid instance of `theflow.modules.optimization_modules.ProfilerConfig` and
