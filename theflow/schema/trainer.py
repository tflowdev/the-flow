...
from theflow.schema.lr_scheduler import LRSchedulerConfig, LRSchedulerDataclassField
from theflow.schema.metadata import TRAINER_METADATA
from theflow.schema.optimizers import (
    BaseOptimizerConfig,
    GradientClippingConfig,
    GradientClippingDataclassField,
    OptimizerDataclassField,
)
from theflow.schema.profiler import ProfilerConfig, ProfilerDataclassField
...
class ECDTrainerConfig(BaseTrainerConfig):
    ...
    def update_batch_size_grad_accum(self, num_workers: int):
        from theflow.utils.trainer_utils import get_rendered_batch_size_grad_accum
...
class GBMTrainerConfig(BaseTrainerConfig):
    ...
    boosting_type: str = schema_utils.StringOptions(
        # TODO: Re-enable "goss" when supported: https://github.com/theflow-ai/theflow/issues/2988
        ["gbdt", "dart"],
        allow_none=False,
        default="gbdt",
