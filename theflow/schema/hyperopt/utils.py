...
def get_parameter_cls(name: str) -> Type["BaseParameterConfig"]:  # noqa: F821
    ...
    Args:
        name: the name of a parameter config class registered in `theflow.schema.hyperopt.parameter`

    Returns:
        A parameter config class from `theflow.schema.hyperopt.parameter`
    """
...
def get_scheduler_cls(name: str) -> Type["BaseSchedulerConfig"]:  # noqa: F821
    ...
    Args:
        name: the name of a scheduler config class registered in `theflow.schema.hyperopt.scheduler`

    Returns:
        A scheduler config class from `theflow.schema.hyperopt.scheduler`
    """
...
def get_search_algorithm_cls(name: str) -> Type["BaseSearchAlgorithmConfig"]:  # noqa: F821
    ...
    Args:
        name: the name of a search algorithm config class registered in `theflow.schema.hyperopt.search_algorithm`

    Returns:
        A scheduler config class from `theflow.schema.hyperopt.search_algorithm`
    """
    return search_algorithm_config_registry[name]
