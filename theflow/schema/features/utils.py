...
"""
As of The Flow v0.7, ECD models support the full range of feature parameters available in The Flow, so any feature schema
can be registered into it. See `BinaryDefaultsConfig` for an example.
"""
ecd_defaults_config_registry = Registry()

"""
As of The Flow v0.7, GBM models only support certain feature types and those features may only contain preprocessing
