...
class CategoryInputFeatureConfigMixin(BaseMarshmallowConfig):
    ...
    input feature and the category global defaults section of the The Flow Config."""
...
class CategoryOutputFeatureConfigMixin(BaseMarshmallowConfig):
    ...
    output feature and the category global defaults section of the The Flow Config."""
...
class LLMCategoryOutputFeatureConfig(CategoryOutputFeatureConfig):
    ...
    feature when using the The Flow Light Model."""
