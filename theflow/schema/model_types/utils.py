...
from theflow.schema.features.utils import output_config_registry
from theflow.schema.hyperopt.scheduler import BaseHyperbandSchedulerConfig
from theflow.schema.llms.generation import LLMGenerationConfig
from theflow.schema.trainer import ECDTrainerConfig
from theflow.types import HyperoptConfigDict, ModelConfigDict
from theflow.utils.data_utils import get_sanitized_feature_name
from theflow.utils.llm_utils import get_context_len
...
def set_validation_parameters(config: "ModelConfig"):
    ...
    if not config.trainer.validation_field:
        if config.trainer.validation_metric is None or config.trainer.validation_metric == LOSS:
            ...
            from theflow.utils.metric_utils import get_feature_to_metric_names_map
...
def set_llm_parameters(config: "ModelConfig") -> None:
    ...
    # GitHub issue: https://github.com/theflow-ai/theflow/issues/3853
    ...
    # GitHub issue: https://github.com/theflow-ai/theflow/issues/3910
    ...
    # GitHub issue: https://github.com/theflow-ai/theflow/issues/3937
...
def _set_generation_max_new_tokens(config: "ModelConfig") -> None:
    ...
    logger.info(
        ...
        "`generation.max_new_tokens` to a different value in your The Flow config."
    )
