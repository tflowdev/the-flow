...
from theflow.constants import SEMANTIC
...
class RetrievalConfig(schema_utils.BaseMarshmallowConfig):
    ...
    def __post_init__(self):
        ...
        # https://github.com/theflow-ai/theflow/pull/3351#discussion_r1181910954
    ...
    index_name: str = schema_utils.String(
        default=None,
        allow_none=True,
        description="The name of the index to use for the prompt. Indices are stored in the theflow cache by default.",
