...
from theflow.constants import BASE_MODEL
from theflow.error import ConfigValidationError
from theflow.schema.metadata import LLM_METADATA
from theflow.schema.metadata.parameter_metadata import convert_metadata_to_json
...
def BaseModelDataclassField():
    description = (
        "Base pretrained model to use. This can be one of the presets defined by The Flow, a fully qualified "
