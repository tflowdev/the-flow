...
from theflow.constants import COMBINED, LOSS, NAME, TYPE
from theflow.modules.metric_registry import get_metric_names_for_type
...
def get_scalar_from_theflow_metric(metric: Metric) -> float:
    """Returns the scalar value of a The Flow metric.
