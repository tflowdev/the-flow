...
from theflow.schema.trainer import LLMTrainerConfig
from theflow.utils.error_handling_utils import default_retry
from theflow.utils.logging_utils import log_once
from theflow.utils.model_utils import find_embedding_layer_with_path

if TYPE_CHECKING:
    from theflow.schema.encoders.text_encoders import LLMEncoderConfig
    ...
    if device == torch.device("cuda") and num_gpus > 1:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            if config_obj.adapter:
                ...
                # Leave this import inline to support a minimal install of The Flow
