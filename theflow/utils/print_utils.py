...
@DeveloperAPI
def get_logo(message, theflow_version):
    return "\n".join(
        [
            "███████████████████████",
            "█ █ █ █  ▜█ █ █ █ █   █",
            ...
            "█     █  ▟█     █ █   █",
            "███████████████████████",
            f"theflow v{theflow_version} - {message}",
            "",
        ]
    )
...
@DeveloperAPI
def print_theflow(message, theflow_version):
    logger.info(get_logo(message, theflow_version))
