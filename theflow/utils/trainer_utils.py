...
from theflow.constants import AUTO, COMBINED, LOSS
...
if TYPE_CHECKING:
    from theflow.features.base_feature import OutputFeature
...
class ProgressTracker:
    ...
    def load(progress_tracking_dict: Dict):
        from theflow.utils.backward_compatibility import upgrade_model_progress
