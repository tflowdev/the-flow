...
# Still needed for preprocessing  TODO(Connor): Refactor theflow/data/preprocessing to use schema
...
def cli_render_config(sys_argv):
    ...
    print_theflow("Render Config", LUDWIG_VERSION)
