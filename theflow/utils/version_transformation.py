...
class VersionTransformation:
    ...
    def __init__(self, transform: Callable[[Dict], Dict], version: str, prefixes: List[str] = None):
        ...
        Args:
            ...
            version: The The Flow version, should be the first version which requires this transform.
...
class VersionTransformationRegistry:
    ...
    def get_transformations(self, from_version: str, to_version: str) -> List[VersionTransformation]:
        ...
        Args:
            from_version: The theflow version of the input config.
    ...
    def update_config(self, config: Dict, from_version: str, to_version: str) -> Dict:
        ...
        Args:
            config: The config, created by theflow at from_version.
            from_version: The version of theflow which wrote the older config.
            to_version: The version of theflow to update to (usually the current LUDWIG_VERSION).

        Returns The updated config after applying update transformations and updating the "theflow_version" key.
        """
        ...
        updated_config["theflow_version"] = to_version
