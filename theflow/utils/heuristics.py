...
from theflow.utils.config_utils import has_pretrained_encoder, has_trainable_encoder, has_unstructured_input_feature
...
def get_auto_learning_rate(config: ModelConfig) -> float:
    ...
    Args:
        config: The Flow config used to train the model.
    """
