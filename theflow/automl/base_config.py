"""Uses heuristics to build theflow configuration file:
...
from theflow.backend import Backend
...
from theflow.utils.automl.data_source import DataSource, wrap_data_source
from theflow.utils.automl.field_info import FieldConfig, FieldInfo, FieldMetadata
from theflow.utils.automl.type_inference import infer_type, should_exclude
...
def get_resource_aware_hyperopt_config(
    ...
    """Returns a The Flow config with the hyperopt section populated with appropriate parameters.
...
# Read in the score and configuration of a reference model trained by The Flow for each dataset in a list.
