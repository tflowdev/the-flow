...
from theflow.types import HyperoptConfigDict, ModelConfigDict, TrainingSetMetadataDict


@PublicAPI
class Callback(ABC):
    def on_cmdline(self, cmd: str, *args: List[str]):
        """Called when The Flow is run on the command line with the callback enabled.

        :param cmd: The The Flow subcommand being run, ex. "train", "evaluate", "predict", ...
    ...
    def on_preprocess_end(self, training_set, validation_set, test_set, training_set_metadata: TrainingSetMetadataDict):
        ...
        :type training_set: theflow.dataset.base.Dataset
        :param validation_set: The validation set.
        :type validation_set: theflow.dataset.base.Dataset
        :param test_set: The test set.
        :type test_set: theflow.dataset.base.Dataset
    ...
    def on_train_start(
        ...
        :param model: The theflow model.
        :type model: theflow.utils.torch_utils.The FlowModule
        :param config: The config dictionary.
    ...
    def on_trainer_train_setup(self, trainer, save_path: str, is_coordinator: bool):
        ...
        :type trainer: trainer: theflow.models.Trainer
    ...
    def on_trainer_train_teardown(self, trainer, progress_tracker, save_path: str, is_coordinator: bool):
        ...
        :param trainer: The trainer instance.
        :type trainer: theflow.models.trainer.Trainer
        :param progress_tracker: An object which tracks training progress.
        :type progress_tracker: theflow.utils.trainer_utils.ProgressTracker
        :param save_path: The path to the directory model is saved in.
        :param is_coordinator: Is this trainer the coordinator.
        """
        pass
