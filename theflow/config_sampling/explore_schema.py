...
from theflow.config_sampling.parameter_sampling import handle_property_type, ParameterBaseTypes
from theflow.constants import SEQUENCE, TEXT, TIMESERIES
...
def explore_properties(
    ...
    Returns:
        ...
        - The first element of the tuple contains a dictionary of config options, which maps from a theflow
...
def generate_possible_configs(config_options: Dict[str, Any]):
    ...
    Args:
        config_options: dictionary mapping from theflow config parameter to all values to be explored.
...
def combine_configs(
    ...
    Args:
        ...
        config: base The Flow config to merge the explored configs with.
    """
