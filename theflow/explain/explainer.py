...
from theflow.constants import BINARY, CATEGORY, TYPE
from theflow.explain.explanation import Explanation, ExplanationsResult
from theflow.explain.util import prepare_data
...
class Explainer(metaclass=ABCMeta):
    def __init__(
        ...
        :param model: (The FlowModel) The The FlowModel to explain.
