...
from theflow.constants import ENCODER_OUTPUT, IMAGE
from theflow.encoders.image.base import ImageEncoder
...
from theflow.schema.encoders.image.torchvision import (
...
from theflow.utils.image_utils import register_torchvision_model_variants, torchvision_model_registry, TVModelVariant
...
class TVBaseEncoder(ImageEncoder):
    def __init__(
        ...
        **kwargs,
        ...
        # remove any The Flow specific keyword parameters
    ...
    def _remove_softmax_layer(self):
        """Model specific method that allows the final softmax layer to be implemented in the The Flow Decoder
        ...
        passed to the The Flow Combiner and then to the Decoder.
