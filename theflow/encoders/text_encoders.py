...
from theflow.constants import ENCODER_OUTPUT, TEXT
...
from theflow.schema.encoders.text_encoders import (
    ALBERTConfig,
...
from theflow.schema.llms.peft import BaseAdapterConfig
from theflow.utils.data_utils import clear_data_cache
from theflow.utils.hf_utils import load_pretrained_hf_model_with_hub_fallback
from theflow.utils.llm_utils import get_context_len, initialize_adapter, load_pretrained_from_config
from theflow.utils.tokenizers import HFTokenizer
from theflow.utils.torch_utils import FreezeModule
...
class HFTextEncoder(Encoder):
    ...
    def _init_transformer_from_scratch(
        ...
        Args:
            ...
            hf_config_params: The HuggingFace config parameters exposed through the The Flow schema.
