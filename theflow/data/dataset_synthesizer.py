...
from theflow.utils.data_utils import save_csv
from theflow.utils.h3_util import components_to_h3
...
def cli(sys_argv):
    parser = argparse.ArgumentParser(
        ...
        prog="theflow synthesize_dataset",
    ...
    # logging.getLogger('theflow').setLevel(
    #     args.logging_level
    # )
    # global logger
    # logger = logging.getLogger('theflow.data.dataset_synthesizer')

    print_theflow("Synthesize Dataset", LUDWIG_VERSION)
