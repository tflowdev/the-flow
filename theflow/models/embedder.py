...
from theflow.constants import ENCODER_OUTPUT, MODEL_ECD, NAME, PROC_COLUMN, TYPE
...
from theflow.schema.features.base import BaseInputFeatureConfig, FeatureCollection
from theflow.schema.features.utils import get_input_feature_cls
from theflow.types import FeatureConfigDict, TrainingSetMetadataDict
...
from theflow.utils.torch_utils import get_torch_device, The FlowModule


@DeveloperAPI
class Embedder(The FlowModule):
    def __init__(self, feature_configs: List[FeatureConfigDict], metadata: TrainingSetMetadataDict):
        super().__init__()

        self.input_features = The FlowFeatureDict()
