#! /usr/bin/env python
#
# Trains a theflow model for every dataset which has a default_model_config.
...
from theflow import datasets, visualize
from theflow.api import The FlowModel
from theflow.globals import LUDWIG_VERSION
from theflow.utils.misc_utils import get_commit_hash
...
def train_all_datasets():
    ...
    with pd.option_context(
        ...
        results_to_display = results_to_display.drop(
            columns=["dataset_version", "output_directory", "theflow_version", "theflow_commit", "has_config"]
        )
