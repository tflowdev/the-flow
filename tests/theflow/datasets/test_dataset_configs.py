...
def test_get_config_and_load(tmpdir):
    yosemite_config = theflow.datasets._get_dataset_config("yosemite")
    assert isinstance(yosemite_config, DatasetConfig)

    yosemite_dataset = theflow.datasets.get_dataset("yosemite", cache_dir=tmpdir)
    ...
    # twitter_bots_config = theflow.datasets._get_dataset_config("twitter_bots")
    # assert isinstance(twitter_bots_config, DatasetConfig)

    # twitter_bots_dataset = theflow.datasets.get_dataset("twitter_bots", cache_dir=tmpdir)
