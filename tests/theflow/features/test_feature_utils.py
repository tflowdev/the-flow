...
from theflow.features import feature_utils


def test_theflow_feature_dict():
    feature_dict = feature_utils.The FlowFeatureDict()
...
def test_theflow_feature_dict_with_periods():
    feature_dict = feature_utils.The FlowFeatureDict()
