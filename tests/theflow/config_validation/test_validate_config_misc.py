...
from theflow.config_validation.validation import check_schema, get_schema
...
from theflow.features.feature_registries import get_output_type_registry
from theflow.schema import utils as schema_utils
from theflow.schema.combiners.utils import get_combiner_jsonschema
from theflow.schema.defaults.ecd import ECDDefaultsConfig
from theflow.schema.defaults.gbm import GBMDefaultsConfig
from theflow.schema.features.preprocessing.audio import AudioPreprocessingConfig
from theflow.schema.features.preprocessing.bag import BagPreprocessingConfig
from theflow.schema.features.preprocessing.binary import BinaryPreprocessingConfig
from theflow.schema.features.preprocessing.category import CategoryPreprocessingConfig
from theflow.schema.features.preprocessing.date import DatePreprocessingConfig
from theflow.schema.features.preprocessing.h3 import H3PreprocessingConfig
from theflow.schema.features.preprocessing.image import ImagePreprocessingConfig
from theflow.schema.features.preprocessing.number import NumberPreprocessingConfig
from theflow.schema.features.preprocessing.sequence import SequencePreprocessingConfig
from theflow.schema.features.preprocessing.set import SetPreprocessingConfig
from theflow.schema.features.preprocessing.text import TextPreprocessingConfig
from theflow.schema.features.preprocessing.timeseries import TimeseriesPreprocessingConfig
from theflow.schema.features.preprocessing.vector import VectorPreprocessingConfig
from theflow.schema.features.utils import get_input_feature_jsonschema, get_output_feature_jsonschema
from theflow.schema.llms.peft import LoraConfig
from theflow.schema.model_types.base import ModelConfig
from theflow.schema.utils import theflow_dataclass, unload_jsonschema_from_marshmallow_class
...
def test_theflow_schema_serialization(model_type):
    import json
    ...
    try:
        ...
        raise TypeError(
            f"The Flow schema of type `{model_type}` cannot be represented by valid JSON. See further details: {e}"
        )
