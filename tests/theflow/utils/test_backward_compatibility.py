...
from theflow.utils.backward_compatibility import (
...
from theflow.utils.trainer_utils import TrainerMetric
...
def test_update_increase_batch_size_on_plateau_max():
    ...
    del updated_config["theflow_version"]
...
def test_old_class_weights_default():
    ...
    del upgraded_config["theflow_version"]
