...
from theflow.constants import IMAGENET1K
from theflow.data.dataset_synthesizer import cli_synthesize_dataset
from theflow.error import ConfigValidationError
from theflow.features.image_feature import ImageAugmentation
from theflow.schema.features.image_feature import ImageInputFeatureConfig
...
def test_local_model_training_with_augmentation_pipeline(
    ...
    model = run_augmentation_training(
        ...
        backend="local",
        encoder=encoder,  # The Flow encoder
        preprocessing=preprocessing,  # The Flow image preprocessing
        augmentation_pipeline_ops=augmentation_pipeline_ops,  # The Flow image augmentation
    )
...
# and focus on interaction of The Flow encoder with image preprocessing and augmentation
@pytest.mark.slow
...
def test_theflow_encoder_gray_scale_image_augmentation_pipeline(
